...
?>
<p class="left"><a href="?page=send-message"><img src="images/icons/berichtsturen.png"> Stuur bericht</a></p>
<center>
<table width="610" cellpadding="0" cellspacing="0">
    <tr>
      ...
      <td width="100" class="top_td"><?php echo $txt['status']; ?></td>
    ...
    $links = false;
    $rechts = false;
    echo '<tr><td colspan="3"><div style="margin-top:15px"><button id="delete" class="button_mini"/>'.$txt['button'].'</button></div></td>
			  <td colspan="3"><div style="margin:15px 0 0 -200px"><div class="sabrosus">';
    if($subpage == 1)
